      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          <div className="relative">
            <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[80%] h-24 bg-purple-500/10 rounded-full blur-3xl" />
                  ...
                  <div className="bg-gray-50 px-4 py-3 flex items-center gap-3 border-b border-gray-200">
                    <div className="relative">
                      ...
                      <motion.span
                        ...
                        className="absolute -top-0.5 -right-0.5 w-3 h-3 rounded-full bg-purple-500 border-2 border-gray-50"
                      />
                    </div>
                    <div>
                      ...
                      <p className="text-[10px] text-purple-500 font-sans">
                        New Hot Lead
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="px-4 py-5 space-y-4 flex-1">
                    ...
                    >
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-xs text-purple-600 font-sans font-bold">
                          96%
                        </span>
                      </div>
                    ...
                    >
                      <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-purple-600 to-violet-500 text-white rounded-xl text-xs font-sans font-bold">
